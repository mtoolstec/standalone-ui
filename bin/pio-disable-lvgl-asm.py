"""Pre-build script for Tab5 (ESP32-P4 / RISC-V).

Rename LVGL ARM Neon/Helium .S assembly files so the RISC-V toolchain does
not attempt to compile them.  The build flag LV_USE_DRAW_SW_ASM=NONE already
prevents any calls to these routines; this step prevents the assembler error.
"""

...
#define _meshtastic_AdminMessage_ModuleConfigType_ARRAYSIZE                                                                      \
    ((meshtastic_AdminMessage_ModuleConfigType)(meshtastic_AdminMessage_ModuleConfigType_TAK_CONFIG + 1))
...
#define meshtastic_SensorConfig_init_default                                                                                     \
    {                                                                                                                            \
        false, meshtastic_SCD4X_config_init_default, false, meshtastic_SEN5X_config_init_default, false,                         \
            meshtastic_SCD30_config_init_default                                                                                 \
    }
...
#define meshtastic_SensorConfig_init_zero                                                                                        \
    {                                                                                                                            \
        false, meshtastic_SCD4X_config_init_zero, false, meshtastic_SEN5X_config_init_zero, false,                               \
            meshtastic_SCD30_config_init_zero                                                                                    \
    }
